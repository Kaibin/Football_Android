	...
	public void setLastUpdated(CharSequence lastUpdated) {
        mRefreshViewLastUpdated.setVisibility(View.VISIBLE);
          ...
          if (lastUpdated != null) {
          	...
          	String DATE_FORMAT = "MM月dd日 HH时mm分";
              String string = "最后更新: " + DateUtil.dateToStringByFormat(new Date(), DATE_FORMAT);
              mRefreshViewLastUpdated.setText(string);
          }
      }
		...
		if (mCurrentScrollState == SCROLL_STATE_TOUCH_SCROLL
			...
			if (firstVisibleItem == 0) {
				...
				if ((mRefreshView.getBottom() > mRefreshViewHeight + 20 || mRefreshView
						.getTop() >= 0) && mRefreshState == PULL_TO_REFRESH) {
					mRefreshViewText
