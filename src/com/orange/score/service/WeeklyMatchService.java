...
//	private FollowMatchManager followMatchManager = FollowMatchManager.getInstance();
	...
	public void loadWeeklyMatch(PPActivity activity, WeeklyMatchServiceCallBack callBack,
			String date) {
		loadWeeklyMatchTask task = new loadWeeklyMatchTask(activity, callBack, date);
		task.execute("");
	}
	...
	private class loadWeeklyMatchTask extends AsyncTask<String, Void, String[]> {
		...
		public loadWeeklyMatchTask(PPActivity activity, WeeklyMatchServiceCallBack callBack,
				String date) {
