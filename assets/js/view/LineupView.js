...
function LineupView(){
	...
	this.mainPanel = new Ext.Panel({
		fullscreen: true,
		bodyStyle:'background-image: url(images/team_bg@2x.png);background-repeat: repeat-y;width: 100%;height: 100%',
		layout: {
	        type: 'hbox',
			align: 'left'
	    }, 
	    ...
	    items: [this.subPanel1,
               this.subPanel2,this.nodataPanel] 
...
//			 Ext.get('nodata-template').dom.style.display = 'block';
			 ...
			 this.subPanel2.hide();
			 this.nodataPanel.update();
			 this.subPanel1.update();
			 this.subPanel2.update();
		}
	}
};
